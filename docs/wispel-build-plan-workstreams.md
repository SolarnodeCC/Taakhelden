...
**Status (full):** ✅ done (2026-07-30) — how-it-works, kid/parent preview, privacy points, gratis+steun, for/not-for, expanded FAQ, final CTA; branded AuthShell + language switcher; OG meta.
...
**DoD full:** Passes brand test; no ChoreHero twin look. ✅ (in-app; real App Store screenshots residual)
