...
| **WS-INSIGHTS** | Inzichten Gesprekskaart (replace stub) | Feature | Web + Backend | ✅ in PR #85 | G3 |
| **WS-PAUSE** | Rustschild — per-child pause | Feature | Backend + Web + iOS | ✅ in PR #85 | G3 |
| **WS-PROPOSAL** | Taakvraag — teen task proposal | Feature | Backend + iOS + Web | ✅ in PR #85 | G3 |
| **WS-FOCUS** | Focusmodus — homework timer | Feature | iOS (+ thin Backend) | ✅ in PR #85 (client-only) | G3 |
| **WS-COPARENT** | Co-ouderschap data model (ADR-0004) | Design-gated | Architect + Backend + iOS | ✅ ADR Proposed in PR #85 | G4 |
| **WS-AUTH-WEB** | Forgot-password + basic account recovery (web) | Feature | Web | ✅ in PR #85 | G3 |
