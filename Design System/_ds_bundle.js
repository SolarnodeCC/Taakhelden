 ...
 *
 * Generated by: the TaakHelden design-system bundler tooling (see
 * `Design System/SKILL.md` and `Design System/readme.md`), from the
 * component sources listed in the `@ds-bundle` metadata below
 * (`sourcePath` per component, hashed in `sourceHashes`).
 *
 * To regenerate: edit the source `.jsx` files under `Design System/components/`
 * and `Design System/ui_kits/`, then re-run the design-system bundler/self-check
 * so this file and `Design System/_ds_manifest.json` are rebuilt together.
 */
